...
//!
//! Backend plan (from v1, cgo-free):
//! - Dialog: `osascript` `display dialog … with hidden answer` flavor used by
//!   internal/prompt, showing WHICH process asked, WHICH box it came from,
//!   and HOW the secret will be delivered. Buttons: Allow Once / Allow &
//!   Remember / Deny (+ Forget for remembered labels). Default button
//!   follows v1: Allow & Remember for askpass-with-biometrics, Allow Once
//!   for direct --env/--stdin.
